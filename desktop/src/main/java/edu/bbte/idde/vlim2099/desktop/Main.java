...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        usedCarDao.createNewUsedCar(thirdCar);
        usedCarDao.updateUsedCar(thirdCar, firstCar.getId());
        LOG.info("First car updated: {}", firstCar);

        usedCarDao.deleteUsedCar(thirdCar.getId());
        LOG.info(usedCarDao.findAllUsedCar().toString());
